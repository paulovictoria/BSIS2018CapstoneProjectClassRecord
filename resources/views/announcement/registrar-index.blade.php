			...
			@foreach ($announcements as $post)
				<div class="card mb-3">
					<div class="card-body">
						<div class="row">
							<div class="col-md-4">
								<img src="{{ route('registrar.announcement.image',['filename'=>$post->image]) }}" alt="image" class="card-img-top">
							</div>
							<div class="col-md-8">
								...
								<p class="card-text">
									...
									<a href="{{ route('registrar.announcement.show',['id' => $post->id]) }}">Read More</a>
								</p>
							</div>
						</div>
					</div>
