				...
				<div class="col-md-6 d-none d-lg-block">
					...
					<div class="row vh-100 d-flex align-items-center justify-content-end text-white">
						<div class="content">
							...
							<hr class="bg-light">
							<p>"Education purpose is to replace an empty mind with an open mind."</p>
							<p class="blockquote-footer text-white">Malcolm Forbes</p>
						</div>
					</div>
							...
							<div class="card my-5">
								<div class="card-body">
									<div class="card-title text-center">
										...
										{!! Form::open(['route'=>'teacher.login.submit']) !!}
									<div class="form-group">
										{!! Form::text('teacher_id', '', ['class'=>'form-control', 'placeholder'=>'Teacher ID']) !!}
									</div>
									<div class="form-group">
									...
									<hr>
										...
										{!! Form::close() !!}
									<a href="{{ route('teacher.password.request') }}" class="btn btn-block btn-outline-secondary">Forgot Password</a>
								</div>
							</div>
